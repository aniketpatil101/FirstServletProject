...
public class VotingElgibilityCheckServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//write b.logic
		if(age>=18) {
			pw.println("<h1 style='color:green;text-align:center'>"+name+" you are  elgible for voting </h1>");
		}
		else {
			pw.println("<h1 style='color:red;text-align:center'>"+name+" you are not elgible for voting </h1>");
		}
